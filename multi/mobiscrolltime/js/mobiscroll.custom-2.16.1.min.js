...
(function(a, g) {
	...
	function n(c, b, d) {
		...
		"string" === typeof b && c.each(function() {
			var a;
			if ((a = i[this.id]) && a[b])
				if (a = a[b].apply(this, Array.prototype.slice.call(d, 1)), a !== g) return f = a, !1
		});
		return f
	}
	...
	var y, r = +new Date,
		i = {},
		u = a.extend,
		f = document.createElement("modernizr").style,
		b = c(["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"]),
		v = c(["flex", "msFlex", "WebkitBoxDirection"]),
		ba = function() {
	...
	y = a.mobiscroll = a.mobiscroll || {
		...
		util: {
			...
			getPosition: function(c, d) {
				var f = window.getComputedStyle ? getComputedStyle(c[0]) : c[0].style,
					n, i;
...
(function(a, g, c, n) {
	var d, y, r = a.mobiscroll,
		...
		v = i.constrain,
		ba = i.isString,
		fa = /android [1-3]/i.test(navigator.userAgent),
	...
	r.classes.Frame = function(i, N, Z) {
		...
		var F, E, ha, m, H, Y, J, l, I, $, A, x, G, da, s, X, o, M, P, q, U, V, ea, Q, e = this,
			O = a(i),
			K = [],
			L = {};
		r.classes.Base.call(this, i, N, !0);
		e.position = function(b) {
			var d, f, h, z, S, k, ca, g, ia, oa, la = 0,
				ma = 0;
			ia = {};
			var i = Math.min(l[0].innerWidth || l.innerWidth(), Y.width()),
				ka = l[0].innerHeight || l.innerHeight();
			if (!(ea === i && Q === ka && b ||
				P))
				if ((e._isFullScreen || /top|bottom/.test(q.display)) && J.width(i), !1 !== G("onPosition", [m, i, ka]) && s) {
					f = l.scrollLeft();
					b = l.scrollTop();
		...
		e.hide = function(b, c, d) {
			...
			if (m) {
				...
				if (f && s && x && !b &&
					!m.hasClass("dw-trans")) m.addClass("dw-out dw-trans").find(".dw").addClass("dw-" + x).on("webkitAnimationEnd animationend", function() {
					aa(b)
				});
				else aa(b);
...
(function(a, g, c, n) {
	...
	y.Scroller = function(g, B, W) {
		...
		function Z(b) {
			if (d) {
				var k = new Date - ea,
					f = v(Math.round(e + (V - Q) / s), O - 1, K + 1),
					g = f,
					z, ca = L.offset().top;
				b.stopPropagation();
				d = !1;
		...
		function ha(a) {
			var b = o.headerText;
			return b ? "function" ===
				typeof b ? b.call(g, a) : b.replace(/\{value\}/i, a) : ""
		}
		...
		function Y(b, c, k, d, e) {
			...
			return {
				selected: k,
				v: d ? v(b, O, K) : b,
				val: f.hasClass("dw-v") || d ? f.attr("data-val") : null
			}
		}
		...
		function J(b, c, k, d, f) {
			!1 !== P("validate", [x, c, b, d]) && (a(".dw-ul", x).each(function(k) {
				var e = a(this),
					g = e.closest(".dwwl").hasClass("dwwms"),
					z = k == c || c === n,
					g = Y(h._tempWheelArray[k], e, d, g, !0);
		...
		var x, G, da, s, X, o, M, P, q, U, V, ea, Q, e, O, K, L, R, ga, C, h = this,
			z = a(g),
			S = {},
			k = {},
			ca = {},
...
(function(a) {
	...
	g.datetime = {
		...
		formatDate: function(c, n, d) {
			if (!n) return null;
			var d = a.extend({}, g.datetime.defaults, d),
				y = function(a) {
					for (var b =
			...
			for (u = 0; u < c.length; u++)
				if (v) "'" == c.charAt(u) && !y("'") ? v = !1 : b += c.charAt(u);
				else switch (c.charAt(u)) {
					case "d":
						b += r("d", d.getDay(n), 2);
						break;
					case "D":
		...
		parseDate: function(c, n, d) {
			var d = a.extend({}, g.datetime.defaults, d),
				y = d.defaultValue || new Date;
			if (!c || !n) return y;
			if (n.getTime) return n;
			var n = "object" == typeof n ? n.toString() : n + "",
				r = d.shortYearCutoff,
				i = d.getYear(y),
				u = d.getMonth(y) + 1,
				f = d.getDay(y),
				...
				Z = function(a, b, c) {
					...
					for (b = 0; b < a.length; b++)
						if (n.substr(w, a[b].length).toLowerCase() == a[b].toLowerCase()) return w += a[b].length, b + 1;
					return 0
				},
				w = 0,
				j;
			for (j = 0; j < c.length; j++)
				if (W) "'" == c.charAt(j) && !ja("'") ? W = !1 : w++;
				else switch (c.charAt(j)) {
					case "d":
						f = N("d");
						break;
					case "D":
	...
	var c = a.mobiscroll,
		...
		r = function(d) {
			...
			function v(a) {
				...
				var b = u(a, "y"),
					c = u(a, "m"),
					d = Math.min(u(a, "d", 1), l.getMaxDayOfMonth(b, c)),
					e = u(a, "h", 0);
			...
			function r(a, b) {
				...
				d = c = a;
				if (2 !== b)
					for (e = fa(c); !e && c < L;) c = new Date(c.getTime() + 864E5), e = fa(c), g++;
				if (1 !== b)
					for (f = fa(d); !f && d > K;) d = new Date(d.getTime() - 864E5), f = fa(d), z++;
				return 1 ===
			...
			function W(a, b, c, d, e, f, g) {
				...
				if (a)
					for (z = 0; z < a.length; z++)
						if (h = a[z], i = h + "", !h.start)
							if (h.getTime) l.getYear(h) == b && l.getMonth(h) == c && (f[l.getDay(h) - 1] = g);
							else if (i.match(/w/i)) {
					i = +i.replace("w", "");
			...
			function ja(c, d, f, z, h, i, S, o, q) {
				var n, p, u, j, s, v, r, t, w, m, x, y, B, C, E, G, I, H, K = {},
					D = {
						h: Q,
						i: e,
						s: O,
				...
				c && (a.each(c, function(a, b) {
					...
					if (k.start && (k.apply || !k.d && !K[M])) {
						...
						if (!q)
							for (m = d + 1; 4 > m; m++) 0 < j[m] && (B = D[f]), s[m] < J[F[m]] && (C = D[f]);
			...
			var p, D, F, E, ha, m, H, Y, J, t = a.extend({}, d.settings),
				l = a.extend(d.settings, c.datetime.defaults, y, T, t),
				I = 0,
				$ = [],
				T = [],
				A = [],
				...
				q = M.match(/a/i),
				U = M.match(/h/),
				V = "datetime" == t ? l.dateFormat + l.separator + l.timeFormat : "time" == t ? l.timeFormat :
				l.dateFormat,
				ea = new Date,
				j = l.steps || {},
				Q = j.hour || l.stepHour || 1,
				e = j.minute || l.stepMinute || 1,
				O = j.second || l.stepSecond || 1,
				j = j.zeroBased,
				K = l.minDate || new Date(l.startYear, 0, 1),
				L = l.maxDate || new Date(l.endYear, 11, 31, 23, 59, 59),
				R = j ? 0 : K.getHours() % Q,
				ga = j ? 0 : K.getMinutes() % e,
				C = j ? 0 : K.getSeconds() % O,
				h = Math.floor(((U ? 11 : 23) - R) / Q) * Q + R,
				z = Math.floor((59 - ga) / e) * e + ga,
				S = Math.floor((59 - ga) / e) * e + ga;
			aa = aa || V;
			if (t.match(/date/i)) {
				a.each(["y", "m", "d"], function(a, b) {
					p = o.search(RegExp(b, "i")); - 1 < p && A.push({
						o: p,
						v: b
					})
				});
			...
			if (t.match(/time/i)) {
				...
				a.each(["h", "i", "s", "a"], function(a, b) {
					a = M.search(RegExp(b, "i")); - 1 < a && A.push({
						o: a,
						v: b
					})
				});
						...
						if (x[d] !== g) {
							...
							if (d == "d") {
								...
								P && a(".dw-li", q).each(function() {
									var b = a(this),
										c = b.data("val"),
										d = l.getDate(h, S, c).getDay(),
										c = o.replace(/[my]/gi, "").replace(/dd/, (c < 10 ? "0" + c : c) + (l.daySuffix || "")).replace(/d/,
											c + (l.daySuffix || ""));
...
(function(a, g) {
	...
	c.presets.scroller.measurement = function(c) {
		...
		var Z = a.extend({}, c.settings),
			w = a.extend(c.settings, n, Z),
			Z = {},
			j = [
				[]
			],
			...
			D = w.batch,
			F, E, ha, m, H = w.sign,
			Y = w.units && w.units.length,
			J = Y ? w.defUnit || w.units[0] : "",
			l = w.unitNames || w.units,
			I = 1 > w.step,
			$ = !1,
			A = I ? Math.max(w.scale, (w.step + "").split(".")[1].length) : 1,
			x = Math.pow(10, A),
			G = Math.round(I ? w.step * x : w.step),
			da, s, X, o = -1,
			M, P, q, U, V, ea, Q, e, O, K, L = 0,
			R = 0,
			ga = {},
			C, h = 0;
		...
		if (H)
			if (H = !1, Y)
				for (C = 0; C < w.units.length; C++) 0 > ba(w.min, J, w.units[C]) && (H = !0);
			else H = 0 > w.min;
		H && (j[0].push({
			values: ["-", "+"],
			label: w.signText
		...
		return {
			...
			validate: function(b, h, k, l) {
				var j = c._tempWheelArray,
					n, p = [],
					t, r, x, y, D, A, L, R = +v(j[M]),
					N = Y ? w.units[j[q]] : "";
				if (H && h === 0) {
					s = Math.abs(s) *
						(j[h] === "-" ? -1 : 1);
